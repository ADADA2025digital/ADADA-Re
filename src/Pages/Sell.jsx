...
export default function Sell() {
  ...
  return (
    <>
      ...
      <PageBanner
        breadcrumb={{ homeLabel: "Home", homeTo: "/", current: "Sell" }}
        heading={{ firstText: "Sell Your Property with", secondText: "Confidence" }}
                  ...
                  <div className="row g-2 align-items-center">
                    ...
                    <div className="col-12 col-lg">
                      <div className="input-group">
                        ...
                        <input
                          type="search"
                          className="form-control custom-placeholder border-0 shadow-none bg-transparent text-light"
